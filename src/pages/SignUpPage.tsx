...
const SignUpPage = () => {
    ...
    const { getAuthUrl, status, data } = useAuth();
                    ...
                    <div className="w-full border-black xl:w-1/2 xl:border-l-2 h-full">
                        <div className="w-full p-4 sm:pt-12 pl-12 pr-12">
                            <h2 className="mb-8 text-2xl font-bold sm:text-title-xl2">
                                {t('sign up to hikerdo')}
                            </h2>
                            <form>
                                <div className='pb-4'>
                                    <span className="label-text">{t('username')}</span>
                                    <label className="input input-bordered flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><title>user icon</title><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" /></svg>
                                        <input type="text" className="grow" placeholder={t('username')} />
                                    </label>
                                </div>
                                ...
                                <div className='pb-8'>
                                    ...
                                    <label className="input input-bordered flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><title>password icon</title><path fillRule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clipRule="evenodd" /></svg>
                                        <input type="password" className="grow" placeholder={t('confirm password')} />
                                    </label>
                                </div>

                                <button type='submit' className='w-full btn btn-primary text-white dark:text-black mb-4'>{t('sign up')}</button>
                                <button type='button' onClick={handleLogin} className='w-full btn fill-primary'><span>
                                ...
                                </span>{t('sign up with github')}</button>
